...
if __name__ == "__main__":
    ...
    positive = spark.read.schema("col0 INT, col1 STRING").csv("file:///home/hayat/Desktop/text sentiment with spark/pashto-sentiment/pashto_tweets/positive-translated.csv").select("col1").cache()
    negative = spark.read.schema("col0 INT, col1 STRING").csv("file:///home/hayat/Desktop/text sentiment with spark/pashto-sentiment/pashto_tweets/negative-translated.csv").select("col1").cache()
    ...
    logistic_model.write().overwrite().save("file:///home/hayat/Desktop/text sentiment with spark/pashto-sentiment/trained-model/logistic-regression/")
    naive_model.write().overwrite().save("file:///home/hayat/Desktop/text sentiment with spark/pashto-sentiment/trained-model/naive-bayes/")
